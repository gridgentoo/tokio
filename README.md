...
* **Tower** (лаконично описывается как fn(Request) → Future<Response>). Такой подход позволяет добиться минимальных задержек («sub-millisecond p99») и потребления памяти («10mb RSS»).
